...
__all__ = ["is_empty", "is_whitespace_only"]
...
def is_empty(document: Document, *, treat_whitespace_as_empty: bool = False) -> bool:
...
def is_whitespace_only(document: Document) -> bool:
