...
def test_build_key_flags_wrapped_in_yellow_when_flagged() -> None:
    info = {"missing_in_docs": 1, "value_types": ["str"], "none_or_empty_count": 0}
    result = _build_key_flags(info)
